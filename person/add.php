...
<div class="container">
    <form class="form" method="POST" action="actions.php">
        ...
        <div class="mb-3"> <label for="place_of_birth" class="form-label">Place of Birth</label>
            <input type="text" class="form-control" id="place_of_birth" name="place_of_birth">
        </div>
        <div class="mb-3"><label for="place_of_birth" class="form-label">Birthday</label>
            <input type="date" class="form-control" id="place_of_birth" name="place_of_birth">
        </div>
        <input type="submit" name="submit_persom" value="Store Person" class="btn btn-primary">
